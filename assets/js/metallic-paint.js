...
class MetallicPaint {
  ...
  updateUniforms() {
    ...
    const light = hexToRgb(o.lightColor);
    const dark = hexToRgb(o.darkColor);
    const tint = hexToRgb(o.tintColor);
  ...
  render(time) {
    ...
    if (this.options.mouseAnimation) {
      this.mouse.x += (this.mouse.targetX - this.mouse.x) * 0.08;
      this.mouse.y += (this.mouse.targetY - this.mouse.y) * 0.08;
      this.animTime = this.mouse.x * 3000 + this.mouse.y * 1500;
    } else {
...
// Auto-initialize any logo tags on the page that request metallic paint
document.addEventListener('DOMContentLoaded', () => {
    // We base64 encode an SVG approximation of the requested logo shape
    const defaultLogoSVG = "data:image/svg+xml;base64,";

    // Real BITVORA logo replica roughly matching the provided design:
    const customLogo = "data:image/svg+xml;base64,";

    const canvases = document.querySelectorAll('.metallic-logo');
    canvases.forEach(canvas => {
        new MetallicPaint(canvas, {
            imageSrc: customLogo,
            seed: 4,
            scale: 2.2, // Tweaked for chrome/silver look
            refraction: 0.015,
            blur: 0.05,
            liquid: 0.4,
            speed: 0.1,
